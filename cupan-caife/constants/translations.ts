...
export const appCopy: Record<AppLanguage, Copy> = {
  ga: {
    ...
    home: {
      ...
      subtitle:
        'Tosaigh i nGaeilge n\u00f3 i mB\u00e9arla, ansin aimsigh caife agus scan do lascaine.',
      irishLabel: 'Gaeilge',
    ...
    scan: {
      ...
      instructions:
        'Ordaigh do chaife as Gaeilge, ansin scan an chlib NFC ag an gcuntar chun do lascaine a \u00e9ileamh.',
      chooseShop: 'Roghnaigh Siopa',
      chooseShopSubtext: 'Pioc do chaif\u00e9',
      steps: [
        'Roghnaigh do shiopa caife',
        'Ordaigh i nGaeilge ag an gcuntar',
        'Scan an chlib NFC',
        'Bain taitneamh as 20% de lacaine',
      ],
      ...
      simNote: 'M\u00f3d taispe\u00e1na. T\u00e1 an NFC insamhlaithe in Expo Go.',
      ...
      errorMessage:
        'D\u00e9an cinnte go bhfuil do ghuth\u00e1n gar don chlib NFC ag an gcuntar.',
    ...
    shop: {
      ...
      howSteps: [
        'Ordaigh do chaife i nGaeilge ag an gcuntar',
        'Scan an chlib NFC le do ghuth\u00e1n',
        'Faigh 20% de lacaine ar d\'ord\u00fa',
      ],
  ...
  en: {
    ...
    home: {
      ...
      subtitle:
        'Start in Irish or English, then find a cafe and scan for your discount.',
      irishLabel: 'Irish',
    ...
    scan: {
      ...
      instructions:
        'Order your coffee as Gaeilge, then scan the NFC tag at the counter to claim your discount.',
      chooseShop: 'Choose a Shop',
      chooseShopSubtext: 'Pick your cafe',
      steps: [
        'Choose your coffee shop',
        'Order in Irish at the counter',
        'Scan the NFC tag',
        'Enjoy 20% off',
      ],
      ...
      simNote: 'Demo mode. NFC is simulated in Expo Go.',
      ...
      errorMessage:
        'Make sure your phone is close to the NFC tag at the counter.',
      retry: 'Try again',
      back: 'Back',
    },
    shop: {
